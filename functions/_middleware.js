    ...
    JSON.stringify(
      {
        ...
        method,
        path: url.pathname,
        hint: "All Second Wind surfaces are GET. Paid doors: GET /api/x402/{sku}. The exact method per path is declared in openapi.json.",
        docs: { openapi: `${url.origin}/openapi.json`, catalog: `${url.origin}/api/catalog` },
      },
      null,
      2
    ),
